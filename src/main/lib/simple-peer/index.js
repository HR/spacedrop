...
class Peer extends DataChannel {
  constructor(opts) {
    ...
    if (this.initiator || this.negotiated) {
      const channelName = this._makeUniqueChannelName(this.channelName)
      const channel = this._pc.createDataChannel(channelName, this.channelConfig)
